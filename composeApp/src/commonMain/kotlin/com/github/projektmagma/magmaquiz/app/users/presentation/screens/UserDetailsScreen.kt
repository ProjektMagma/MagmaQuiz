...
fun UserDetailsScreen(
    ...
    val quizzesUiState by userDetailsViewModel.quizzesUiState.collectAsStateWithLifecycle()
    ...
    when (userUiState) {
        is UiState.Error -> FullSizeErrorIndicator(
            message = (userUiState as UiState.Error).errorMessage,
            onRetry = {
                userDetailsViewModel.onCommand(UserDetailsCommand.GetUserData)
            }
                ...
                AutoScalableLazyColumn(
                    ...
                    QuizCardSmall(
                        ...
                        changeFavoriteStatus = {
                            userDetailsViewModel.onCommand(
                                UserDetailsCommand.ChangeFavoriteStatus(
                                    quiz.id!!
                                )
                            )
                        },
