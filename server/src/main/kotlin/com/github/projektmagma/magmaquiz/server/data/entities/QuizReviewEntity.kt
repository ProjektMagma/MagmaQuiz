...
import com.github.projektmagma.magmaquiz.shared.data.domain.QuizzesReview
...
class QuizReviewEntity(id: EntityID<UUID>) : ExtUUIDEntity(id, QuizzesReviewsTable),
    DomainCapable<QuizzesReview, ConversionCommand> {
    ...
    override fun toDomain(command: ConversionCommand): QuizzesReview {
        return transaction {
            QuizzesReview(
